...
if [[ $ISLARGEIMAGE -eq 1 ]];
  then
    RIGIDCONVERGENCE="[1000x500x250,1e-5,10]"
    RIGIDSHRINKFACTORS="12x8x4"
    RIGIDSMOOTHINGSIGMAS="4x3x2vox"

    AFFINECONVERGENCE="[1000x500x250,1e-5,10]"
    AFFINESHRINKFACTORS="12x8x4"
    AFFINESMOOTHINGSIGMAS="4x3x2vox"

    SYNCONVERGENCE="[300x300x200x200x120,1e-6,10]"
...
RIGIDSTAGE="--transform ${tx}[0.1] \
            --metric CC[${FIXEDIMAGES[0]},${MOVINGIMAGES[0]},1,${CCRADIUS},Regular,0.2] \
